...
/** @override */
DragLinkingTool.prototype.doActivate = () => {
    const { diagram } = this;
...
export default class WorkflowEditor extends React.Component<any, any> {
    nodeId = 0;
    ...
    createDiagram1 = (diagramId: string) => {
        // For conciseness. See the "Building Parts" intro page for more
        const $ = go.GraphObject.make;
        const myDiagram = $(go.Diagram, diagramId, // create a Diagram for the DIV HTML element
            {
                // enable undo & redo
                'undoManager.isEnabled': true,
            });
        // the node template describes how each Node should be constructed
        myDiagram.nodeTemplate = $(go.Node, 'Auto', // the Shape automatically fits around the TextBlock
    ...
    createDiagram = (diagramId: string) => {
        ...
        //         { mouseDrop() { myDiagram.commandHandler.deleteSelection(); } },
        //         $(go.Shape,
